...
export const EducationSection = ({
  ...
  return (
    ...
    >
      <div className="gap-y-10 lg:gap-x-10 grid grid-cols-12">
      {/* Sisi Kiri: Profil & Teks Branding */}
        <div className="flex justify-center flex-col col-span-12 lg:col-span-7 gap-10">
          ...
          <div className="flex flex-col gap-5">
            <p className="text-lg sm:text-xl text-zinc-300">
              Education that helps me build character, improve skills,
        ...
        <div className="col-span-12 lg:col-span-5 border-l-4 border-brand-green p-3 sm:p-6 flex flex-col gap-y-14">
